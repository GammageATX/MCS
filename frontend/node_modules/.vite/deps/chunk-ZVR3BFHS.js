...
var require_unset2 = __commonJS({
  "../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/fp/unset.js"(exports, module) {
    var convert = require_convert();
...
// ../node_modules/.pnpm/@jsonforms+react@3.4.1_@jsonforms+core@3.4.1_react@18.3.1/node_modules/@jsonforms/react/lib/jsonforms-react.esm.js
var import_react = __toESM(require_react());
var import_maxBy2 = __toESM(require_maxBy());

// ../node_modules/.pnpm/@jsonforms+core@3.4.1/node_modules/@jsonforms/core/lib/jsonforms-core.esm.js
...
var getOrCreateAjv = (state, action) => {
  if (action) {
    if (hasAjvOption(action.options)) {
      ...
      if ((0, import_lodash.isFunction)(action.options.compile)) {
...
var createDefaultValue = (schema, rootSchema) => {
  ...
  if (hasType(resolvedSchema, "string")) {
    ...
    return "";
  } else if (hasType(resolvedSchema, "integer") || hasType(resolvedSchema, "number")) {
    return 0;
...
var extractDefaults = (schema, rootSchema) => {
  if (hasType(schema, "object") && schema.default === void 0) {
    ...
    for (const key in schema.properties) {
      ...
      if (resolvedProperty.default !== void 0) {
...
var computeChildLabel = (data, childPath, childLabelProp, schema, rootSchema, translateFct, uiSchema) => {
  ...
  if (isEnumSchema(childSchema)) {
    ...
    const oneOfSchema = oneOfArray.find((e) => (0, import_lodash.isEqual)(e.const, currentValue));
    if (oneOfSchema) {
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZVR3BFHS.js.map
