...
var require_startCase = __commonJS({
  "../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/startCase.js"(exports, module) {
...
var require_set2 = __commonJS({
  "../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/fp/set.js"(exports, module) {
...
var require_maxBy = __commonJS({
  "../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/maxBy.js"(exports, module) {
...
// ../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/_basePullAt.js
var require_basePullAt = __commonJS({
  "../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/_basePullAt.js"(exports, module) {
...
// ../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/remove.js
var require_remove = __commonJS({
  "../node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/remove.js"(exports, module) {
    var baseIteratee = require_baseIteratee();
...
// ../node_modules/.pnpm/@jsonforms+core@3.1.0/node_modules/@jsonforms/core/lib/jsonforms-core.esm.js
...
var reuseAjvForSchema = (ajv, schema) => {
...
var getOrCreateAjv = (state, action) => {
  ...
  if (state.ajv) {
    return (action == null ? void 0 : action.schema) ? reuseAjvForSchema(state.ajv, action.schema) : state.ajv;
  }
  return createAjv();
};
  ...
  switch (action.type) {
    ...
    case UPDATE_DATA: {
      if (action.path === void 0 || action.path === null) {
        ...
        const newState = (0, import_set.default)(action.path, newData, state.data === void 0 ? {} : state.data);
...
var isEnumControl = and(uiTypeIs("Control"), or(schemaMatches((schema) => Object.prototype.hasOwnProperty.call(schema, "enum")), schemaMatches((schema) => Object.prototype.hasOwnProperty.call(schema, "const"))));
...
var mapStateToMasterListItemProps = (state, ownProps) => {
  const { schema, path, index: index2 } = ownProps;
  const firstPrimitiveProp = schema.properties ? (0, import_find.default)(Object.keys(schema.properties), (propName) => {
...
var createLabel = (subSchema, subSchemaIndex, keyword) => {
  if (subSchema.title) {
...
//# sourceMappingURL=chunk-ETUF23DC.js.map
