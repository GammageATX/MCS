...
export declare const withJsonFormsLayoutProps: <T extends LayoutProps>(Component: React.ComponentType<T>, memoize?: boolean) => React.ComponentType<T & OwnPropsOfLayout>;
...
export declare const withTranslateProps: <P extends {}>(Component: React.ComponentType<TranslateProps & P>) => (props: P) => React.JSX.Element;
export declare const withArrayTranslationProps: <P extends ArrayLayoutProps>(Component: React.ComponentType<P & {
